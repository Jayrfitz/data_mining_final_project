...
```{r}
plot(density(dat$G1*5), main = "Student's grades", col = "red4", ylim=c(0,0.035), xlab = 'grade out of 100', xlim=c(0,100),lwd = 2)
lines(density(dat$G2*5), col="green",lwd = 2)
lines(density(dat$G3*5), col="blue",lwd = 2)
legend("topleft", c("grade after 1st test","grade after 2nd test","final grade"), pch = 15,col = c("red4","green", 'blue'),
       inset = .05)
```
