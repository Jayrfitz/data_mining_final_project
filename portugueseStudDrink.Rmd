...
```{r}
hist(dat$Dalc[dat$sex == "F"], col = "red4", main = "Workday Alcohol Consumption by Sex (Female)", xlab = "Alcohol Consumption (Scale of 1-5)")
hist(dat$Dalc[dat$sex == "M"], col = "red4", main = "Workday Alcohol Consumption by Sex (Male)", xlab = "Alcohol Consumption (Scale of 1-5)")
