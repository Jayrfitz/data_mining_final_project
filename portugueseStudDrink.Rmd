...
```{r}
par(mfrow=c(1, 2))
hist(dat$Dalc[dat$sex == "F"], col = "red4", main = "Female", xlab = "Alcohol Consumption (Scale of 1-5)")
hist(dat$Dalc[dat$sex == "M"], col = "red4", main = "Male", xlab = "Alcohol Consumption (Scale of 1-5)")
